...
<body>
  ...
  <li><a href="../Accueil/deconnexion.php">Déconnexion</a></li>
    ...
    <div >
     ...
     $ET_CNE=$_GET['CNE_MODIFIER'];
     
     $query_admin = "SELECT * FROM Etudiant WHERE ET_CNE='$ET_CNE'";
     $result_admin = mysqli_query($connexion, $query_admin);
     if ($result_admin->num_rows > 0) {
      if ($row  = $result_admin->fetch_assoc()) {
      
      ?> 
                        <H1 align="center">Modifier(Etudiant)</H1>
                      <table>
                            <tr >
                              <td>
                            ...
                            <button type="submit"  name="MODIFIER_ADMIN_ETUDIANT" class="submit"  id="submit" style="left: 55%; top: 30px;">Modifier</button>
                              </td>
                              <td>
