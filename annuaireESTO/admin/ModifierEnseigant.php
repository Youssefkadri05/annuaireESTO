 ...
 <header>
  ...
  <li><a href="../Accueil/deconnexion.php">Déconnexion</a></li>
    ...
    <div >
     ...
     $EN_PPR=$_GET['EN_PPR_MODIFIER'];
     
     $query_admin = "SELECT * FROM enseignant WHERE EN_PPR='$EN_PPR'";
     $result_admin = mysqli_query($connexion, $query_admin);
     if ($result_admin->num_rows > 0) {
      if ($row  = $result_admin->fetch_assoc()) {
      
      ?> 
                        <H1 align="center">Modifier(Enseignant)</H1>
                      <table>
                            <tr >
                              <td>
                          ...
                          <tr>
                            ...
                            <button type="submit"  name="MODIFIER_ADMIN_ENSEIGANAT" class="submit"  id="submit" style="left: 20%; top: 30px;">Modifier</button>
                              </td>
                              <td>
