 ...
 <header>
  ...
  <li><a href="../Accueil/deconnexion.php">Déconnexion</a></li>
    ...
    <div >
     ...
     <?php 
     $F_EMAIL=$_SESSION['EMAIL_CONNECT'];
     $query_admin = "SELECT * FROM Fonctionnaire WHERE F_EMAIL='$F_EMAIL'";
      ...
      ?> 
                      ...
                      <table>
                          ...
                          <tr>
                            ...
                            <button type="submit"  name="MODIFIER_PROFIL_FONCTIONNAIRE" class="submit"  id="submit" style="left: 20%; top: 30px;">Modifier</button>
                              </td>
                              <td>
