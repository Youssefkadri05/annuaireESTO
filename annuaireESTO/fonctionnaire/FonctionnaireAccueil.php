...
<head>
    ...
    <script type="text/javascript">
        function FunctionValue1(){
                ...
                document.location.href = "../Fonctionnaire/FonctionnaireAccueil.php?MOT_RECHERCHE="+valuer ;
...
<body>
   <header>
        <nav class="nav" id="menu">
          ...
          <ul>
  <li><a href="FonctionnaireAccueil.php">Accueil</a></li>
  ...
  <li><a href="../Accueil/deconnexion.php">Déconnexion</a></li>
    ...
    <div class="div_de_recherche">
     ...
     <H2 style="position: absolute; top: 0px; color: #66a3ff; left: 190px; border: #66a3ff solid 1px; padding: 15px; font-size: 25px; width: 70%; background: white;">Bienvenue notre cher fonctionnaire <?php echo strtoupper($_SESSION['NOM_CONNECT']).' '.$_SESSION['PRENOM_CONNECT'];?> vous pouvez rechercher l’adresse e-mail de n’importe quel membre et l'inverse </H2>       
                ...
                else
                {
                  ...
                  $prenom="";
                   ...
                   $result4 = mysqli_query($connexion, $query4);
                      ...
                      header('Refresh: 0; url=FonctionnaireAccueil.php');
